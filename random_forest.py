...
st.set_page_config(layout='wide',page_title="Iris flower classification",page_icon='D:\\Machine_learning\\random_forest\\iris_petal_sepal.png')

st.markdown("<h1 style='text-align: center; color: #5A4FCF;'>Iris flower classification (Random Forest)</h1>", unsafe_allow_html=True)

col1,col2 = st.columns([1,2])
col1.image("D:\\Machine_learning\\random_forest\\Iris_petal_sepal.png")
...
model = joblib.load("D:\\Machine_learning\\random_forest\\model.joblib")
...
co1.code("Accuracy :"+str(model.score(x_test,y_test)))
co1.write("Model gives same accuracy by increasing the value of n_estimators from 10")
